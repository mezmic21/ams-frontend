...
export default function AdminNotifications() {
  ...
  const t = isDark ? {
    ...
    readBg: "#0a0f1e", readBorder: "#1e2d4a", roleBg: "#3b1764", roleText: "#c084fc",
  } : {
    ...
    readBg: "#f8fafc", readBorder: "#e2e8f0", roleBg: "#f3e8ff", roleText: "#7e22ce",
  };
        ...
        <div className="flex items-center gap-3">
          <div className="text-right">
            ...
            <span className="text-xs px-2 py-0.5 rounded-full"
              style={{ background: t.roleBg, color: t.roleText }}>Admin</span>
          </div>
          <button
      ...
      <div className="max-w-3xl mx-auto px-6 py-8">
        ...
        {loading ? (
          ...
          <div className="text-center py-16 rounded-2xl"
            ...
            <p className="text-sm mt-1" style={{ color: t.textMuted }}>
              Cancellations and reschedule requests will appear here
            </p>
          </div>
        ) : (
